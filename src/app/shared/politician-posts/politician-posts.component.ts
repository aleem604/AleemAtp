...
@Component({
    selector: 'politician-posts',
    templateUrl: './politician-posts.component.html',
    styleUrls: ['./politician-posts.component.scss'],
    styles: [
        `
...
export class PoliticianPostsComponent implements OnInit {
    articles = [
        {
