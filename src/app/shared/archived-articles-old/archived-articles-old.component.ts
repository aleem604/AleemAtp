...
@Component({
    selector: 'archived-articles-old',
  templateUrl: './archived-articles-old.component.html',
  styleUrls: ['./archived-articles-old.component.scss']
})
export class ArchivedArticlesOldComponent implements OnInit {
  archives = [
    {
      date: 'September 2016',
      count: '124',
