...
@Component({
  selector: 'write-letter-edit',
    templateUrl: './write-letter-edit.component.html',
    styleUrls: ['./write-letter-edit.component.scss'],
})
export class WhiteLetterEditComponent implements OnInit {
  letters = {
    "federal":
      [
