import { Component, OnInit, Input, ViewChild, ElementRef, AfterViewInit, AfterContentChecked, AfterViewChecked, AfterContentInit } from '@angular/core';
declare var $: any;
...
export class ArchivedArticlesComponent implements OnInit, AfterContentInit {
